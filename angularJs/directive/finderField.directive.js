...
angular.module('gaetan').directive('finderField', [
  '$compile',
  function ($compile) {
    return {
      restrict: 'A',
    ...
    var link = function ($scope, $element, $attrs, $controller) {
       ...
       * @Define options
       */
      var limit = parseInt($attrs.finderField)
        ? parseInt($attrs.finderField)
        : 4;
      ...
      function initScope() {
        ...
        childScope.selectField = function (select, $index) {
          ...
          if (multiple) {
            ...
            childScope.finderFields.splice(
              childScope.finderFields.indexOf(select),
              1
            );
      ...
      function initDom() {
        ...
        liDom.setAttribute(
          'ng-repeat',
          'finderField in finderFields  | filter:searchText | limitTo:' +
            limit +
            ''
        );
